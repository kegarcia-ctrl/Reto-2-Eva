...
public class Property {
    ...
    @JsonProperty("tieneCalefaccion")
    @Column(name = "tiene_calefaccion")
    private Boolean hasHeating = false;

    @JsonProperty("tieneVigilancia")
    @Column(name = "tiene_vigilancia")
    private Boolean hasSecurity = false;

    @JsonProperty("tieneGimnasio")
    @Column(name = "tiene_gimnasio")
    private Boolean hasGym = false;

    @JsonProperty("tieneTerraza")
    @Column(name = "tiene_terraza")
    private Boolean hasTerrace = false;

    @JsonProperty("admiteMascotas")
    @Column(name = "admite_mascotas")
    private Boolean allowsPets = false;

    @JsonProperty("tieneCheckinAutomatico")
    @Column(name = "tiene_checkin_automatico")
    private Boolean hasSelfCheckin = false;
    ...
    @ManyToMany
    @JoinTable(name = "servicios_propiedad", joinColumns = @JoinColumn(name = "propiedad_id"), inverseJoinColumns = @JoinColumn(name = "servicio_id"))
    @JsonProperty("servicios")
    private List<PropertyServiceEntity> services = new ArrayList<>();
